...
class Classifier(nn.Module):
    ...
    def __init__(self,  classes, seqlen,
        ...
        self.replay_mode = "current"    # should replay be used, and if so what kind? (none|current|buffer|all|generative)
        self.replay_targets = "soft" # should distillation loss be used? (hard|soft)
        ...
        self.lwf_weighting = True   # LwF has different weighting of the 'stability' and 'plasticity' terms than replay
    ...
    def construct_memory_set(self, dataset, n):
        ...
        for k in indeces_selected:
            # print('dataset[k][1].numpy()=', dataset[k][1].numpy())
